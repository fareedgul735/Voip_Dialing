...
const AwardCard = ({ year }) => (
  <div className="w-full bg-white rounded-xl shadow-sm border border-gray-100 py-8 sm:py-12 px-4 sm:px-6 flex flex-col md:flex-row gap-6">
    {/* Text Content */}
    <div className="flex-1">
      ...
      <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 leading-snug">
        VoIP Dialing Inc. Received {year} INTERNET TELEPHONY Product of the Year Award
      </h2>
      ...
      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        solutions, supporting Call-Centers and other businesses across the US.
      </p>
    </div>

    {/* Image */}
    <div className="flex-shrink-0 flex justify-center md:justify-end">
      <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 rounded-full border-4 border-red-600 flex items-center justify-center overflow-hidden">
        <img
          src={title6}
          alt={`Award ${year}`}
      ...
      <section className="space-y-6">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            to reap the rewards of our knowledge, advanced technology, and
            innovations while saving money.
          </p>
        </div>
