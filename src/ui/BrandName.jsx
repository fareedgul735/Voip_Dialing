...
const BrandName = () => {
  ...
  return (
    <div
      className="relative mx-12 w-full lg:w-[85%] p-6 sm:p-8
      bg-[linear-gradient(180deg,_#E2C8B5_0%,_rgba(255,224,208,0.8)_20%,_rgba(226,200,181,0)_100%)]
      rounded-4xl shadow-sm"
    >
      <div
        className="absolute bg-orange-500 text-white rounded-2xl text-center shadow-lg z-10
      ...
      >
        ...
        <p className="mt-2 leading-snug text-xs sm:text-sm">
          Certified & <br />
          Authorized <br />
          Reseller / Integrator
        </p>
