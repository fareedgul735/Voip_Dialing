...
const VoIPPricingInterface = () => {
  ...
  return (
    <>
      <SEO
        title="Affordable Business VoIP Pricing Plans | Voip Dialing ORC"
        description="Compare our business VoIP pricing plans with advanced cloud PBX features, unlimited calling and secure team collaboration. Get enterprise-grade communication at lower cost."
                ...
                >
                  <div
                    onClick={() => {
                      ...
                      setOpenCollapse(
                        openCollapse === item.id ? null : item.id,
                      );
                    }}
                      ...
                      {item.id === "cloud" && (
                        ...
                        >
                          ...
                          <div className="text-xs text-gray-600 italic">
                            * PBX orders are processed within 1 to 3 business
                            days from the time placed, varied by the speed we
                            collect the desired specs from you.
                          </div>
                        </div>
                      )}
                              ...
                              <div className="flex items-center gap-4 bg-orange-50 border-l-4 border-orange-400 px-6 py-4 text-center w-full justify-center">
                                <div>
                                  ...
                                  <div className="text-sm text-gray-600">
                                    You can go to above <b>'Phone Number'</b>{" "}
                                    tab to add numbers.
                                  </div>
                                </div>
                              </div>
