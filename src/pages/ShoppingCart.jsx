...
export default function ShoppingCart() {
  ...
  return (
    <>
      <NoIndexSEO
        title="Shopping Cart | Voip Dialing ORC"
        url="https://voip-dialing.vercel.app/shoppingCart"
      />
          ...
          <div className="w-full lg:max-w-[420px] lg:sticky lg:top-6 self-start">
            <div className="w-full bg-white rounded-2xl border border-orange-400 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                ...
                {/* Login Button */}
                <Link to={"/signin"}>
                  <button className="w-full cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-semibold py-4 rounded-full mb-4 transition-colors">
                    Log In
                  </button>
                </Link>
